...
def _header_label(display_label: str | None, original_filename: str) -> str:
...
def build_qr_pdf(
    ...
    for page_index in range(total_pages):
        ...
        for idx, chunk in enumerate(page_chunks):
            ...
            c.drawCentredString(x + CELL_W / 2, y + 3, _footer_label(chunk))
...
def build_qr_page_images(
    ...
    cell_h_px = int(
        (page_h_px - margin_px - header_px - int((FOOTER_H / 72.0) * PNG_SCALE * 72) - margin_px)
        / ROWS
    )
