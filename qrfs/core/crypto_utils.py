...
def _sign_blob(
    unsigned_blob: bytes, sender_signing_private_key_b64: str | None
...
def encrypt_file_payload_password(
    payload: bytes,
    password: str,
...
def decrypt_file_payload_pubkey(
    blob: bytes, private_key_b64: str
...
def decrypt_file_payload_auto(
    blob: bytes, password: str | None = None, private_key_b64: str | None = None
) -> tuple[bytes, str, str | None, dict | None]:
